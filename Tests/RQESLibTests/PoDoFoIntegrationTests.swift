...
final class PoDoFoIntegrationTests: XCTestCase {
    ...
    func testPoDoFoSessionRuns() throws {
        ...
        let session = PodofoWrapper(
            conformanceLevel:    ConformanceLevel.ADES_B_LT.rawValue,
